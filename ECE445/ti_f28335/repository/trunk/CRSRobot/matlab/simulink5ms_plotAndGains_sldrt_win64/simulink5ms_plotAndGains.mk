...
SHARED_LIB           := 
TARGET_LANG_EXT      := c
OPTIMIZATION_FLAGS   := -O4 -O4 -O4 -O4 -O4 -O4 -O4 -O4 -O4 -O4 -O4 -O4 -O4 -O4
ADDITIONAL_LDFLAGS   := 
DEFINES_CUSTOM       := 
...
# additional includes
REQ_INCLUDES += ;C:/bacula2_jabyrns2/repository/trunk/CRSRobot/matlab;C:/bacula2_jabyrns2/repository/trunk/CRSRobot/matlab/simulink5ms_plotAndGains_sldrt_win64;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
