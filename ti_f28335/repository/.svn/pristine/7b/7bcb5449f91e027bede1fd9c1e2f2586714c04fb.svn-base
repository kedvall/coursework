function [out3] = ME446_serialread_address(address,varsize)
%ME446_SERIALREAD_ADDRESS
%   N = ME446_serialread_address(ADDRESS,VARSIZE) will return data from the
...
%
%		mydata = ME446_serialread_address(128432,1);
%
